...
def generate_state_combinations( list_of_states, balls, robots, rooms ):
...
if __name__ == "__main__":
    ...
    generate_state_combinations( states_dict[number_of_balls], number_of_balls, number_of_robots, number_of_rooms )